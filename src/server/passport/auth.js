...
function signup({ firstName, lastName, email, password, emailToken, emailTokenExpiresAt, isActive, req }) {
  const user = new User({ firstName, lastName, email, password, emailToken, emailTokenExpiresAt, isActive })
